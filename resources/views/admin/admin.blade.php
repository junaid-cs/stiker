...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">DeliDave /</span> Admins List
</h4>
...
<div class="app-ecommerce-category">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="">
             ...
             <a href="{{route('deleteadmin',$view->id)}}" type="button" class="btn text-danger my-1"><i class="fa fa-trash"></i></a>
 ...
 aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <button type="button" class="btn-close"
            ...
            <div class="modal-body">
            <form id="formAccountSettings" action="{{route('updateadmin')}}" method="POST" >
                @csrf

...
.contact-info span{
    ...
    <div class="w3l_banner_nav_right">
        ...
        <div class="privacy about">
            <h3>Order<span> Products</span></h3>
    ...
    <div class="item-image">
             @php
             $images = explode(',',$item->products->image);
            @endphp
    ...
    <div class="item-details">
        ...
        <div class="item-actions">
            <button class="btn-remove" data-toggle="modal" data-target="#ratingModal"> Rate Item</button>
    ...
    <div class="item-quantity-price">
        ...
        <p class="cartprice">${{$item->total}} AED</p>
    </div>
</div>

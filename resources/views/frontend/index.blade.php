...
<div class="d-flex flex-wrap position-relative">
	...
	<div class="right_card ml-2">
		<div class="d-flex flex-wrap home_banner" data-aos="fade-left" data-aos-duration="1500">
			<img src="{{asset('../asset2/images/bn1.jpg')}}"  class="img-fluid" width="100%">
			<img src="{{asset('../asset2/images/bn2.jpg')}}" class="img-fluid" width="100%">
		</div>
...
<div class="container button_section" style="overflow: hidden;">
	...
	<img  src="{{asset('../asset2/images/hover-1.jpg')}}"  class="img-fluid " style="object-fit: cover;" width="100%"  height="400px" alt="Main Image">
</div>
<div class="col-12 col-md-6" data-aos="fade-left" data-aos-duration="1500" style="padding: 0;">
		<div class="overlay" > 
			<span class="sample">Get samples</span>
		</div>
			<img  src="{{asset('../asset2/images/hover-2.jpg')}}"  class="img-fluid" style="object-fit: cover;" width="100%" height="400px" alt="Main Image">
	</div>
	</div>
</div>
<!-- fresh-vegetables -->
		...
		<div class="w3l_fresh_vegetables_grids">
			<div class="col-md-12 w3l_fresh_vegetables_grid_right">
				<div class="col-md-3 w3l_fresh_vegetables_grid">
					<div class="w3l_fresh_vegetables_grid1" data-aos="fade-right" data-aos-duration="1500">
					<img src="{{asset('../asset2/images/For_a_gym.jpg')}}" alt=" " class="img-responsive" />
						<!-- <img src="{{asset('../asset2/images/bg-1.jpg')}}" alt=" " class="img-responsive" /> -->
					</div>
					<div class="w3l_fresh_vegetables_grid1" data-aos="fade-left" data-aos-duration="1000">
					<img src="{{asset('../asset2/images/For_a_gym.jpg')}}" alt=" " class="img-responsive" />
						<!-- <img src="{{asset('../asset2/images/bg-1.jpg')}}" alt=" " class="img-responsive" /> -->
					</div>
					<div class="w3l_fresh_vegetables_grid1" data-aos="fade-bottom" data-aos-duration="1000">
					<img src="{{asset('../asset2/images/For_a_gym.jpg')}}" alt=" " class="img-responsive" />
						<!-- <img src="{{asset('../asset2/images/bg-1.jpg')}}" alt=" " class="img-responsive" /> -->
					</div>
				</div>
				...
				<div class="col-md-3 w3l_fresh_vegetables_grid">
					...
					<!--</div>-->
					<div class="w3l_fresh_vegetables_grid1_bottom">
						<img src="{{asset('../asset2/images/bg-3.jpg')}}" alt=" " class="img-responsive" />
					</div>
				</div>
				<div class="clearfix"> </div>
